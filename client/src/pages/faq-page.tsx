    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          Then fill out the form with all the information asked, make sure to
          not miss any of the fields.{' '}
        </p>
      </div>
      <h2>How do I claim an item?</h2>
      <p>
        To claim an item search for the item you wish to claim. Then scroll to
        the item that you own and click on the item to get to that items page.
      ...
      <p>
        If you need a video walkthrough, you can find them here and on our
      ...
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=HC9zMXsKgy-uHmaE"
